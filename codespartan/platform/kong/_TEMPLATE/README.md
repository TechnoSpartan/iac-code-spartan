...
|----------|-------------|---------|
| `{{DOMAIN_NAME}}` | Nombre corto del dominio | `dental-ia` |
| `{{DOMAIN_HOST}}` | Dominio principal | `dental-ia.es` |
| `{{API_HOST}}` | Host de la API produccion | `api.dental-ia.es` |
| `{{API_STAGING_HOST}}` | Host de la API staging | `api-staging.dental-ia.es` |
...
| `{{CORS_ORIGIN_PROD}}` | Origen CORS produccion | `https://dental-ia.es` |
| `{{CORS_ORIGIN_WWW}}` | Origen CORS www | `https://www.dental-ia.es` |
| `{{CORS_ORIGIN_STAGING}}` | Origen CORS staging | `https://staging.dental-ia.es` |
...
sed -i '' 's/{{DOMAIN_NAME}}/dental-ia/g' docker-compose.yml kong.yml
sed -i '' 's/{{DOMAIN_HOST}}/dental-ia.es/g' docker-compose.yml kong.yml
sed -i '' 's/{{API_HOST}}/api.dental-ia.es/g' docker-compose.yml kong.yml
sed -i '' 's/{{API_STAGING_HOST}}/api-staging.dental-ia.es/g' docker-compose.yml kong.yml
...
sed -i '' 's/{{CORS_ORIGIN_PROD}}/https:\/\/dental-ia.es/g' kong.yml
sed -i '' 's/{{CORS_ORIGIN_WWW}}/https:\/\/www.dental-ia.es/g' kong.yml
sed -i '' 's/{{CORS_ORIGIN_STAGING}}/https:\/\/staging.dental-ia.es/g' kong.yml
```
