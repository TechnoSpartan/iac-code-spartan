...
**Ubicación:** Después de "La Arquitectura: Componentes Clave"

**Descripción:** Diagrama de flujo mostrando los 5 jobs del pipeline
...
**Descripción:** Diagrama mostrando cómo se conectan todos los componentes
...
2. **Diagrama de Arquitectura** → Después de "La Arquitectura: Componentes Clave"
3. **Diagrama del Pipeline** → Después del diagrama de arquitectura
4. **Captura GitHub Actions** → En "El Workflow: Paso a Paso"
5. **Captura Docker Build** → En "Docker Multi-Stage"
6. **Diagrama de Rollback** → En "Job 3: Deploy"
7. **Captura Discord** → En "Job 5: Notificaciones"
8. **Gráfico Comparativo** → En "Los Números: Métricas Reales"
9. **Captura Grafana** → En "Las Métricas Importan" (opcional)
